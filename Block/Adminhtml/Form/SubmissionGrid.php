...
class SubmissionGrid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var \Cytracon\BlueFormBuilderCore\Model\Form\Submission\CollectionFactory
     */
     ...
     * @param \Cytracon\BlueFormBuilderCore\Model\Form\Submission\CollectionFactory $collectionFactory 
     * @param array                                                         $data              
     */
    public function __construct(
        ...
        \Cytracon\BlueFormBuilderCore\Model\Form\Submission\CollectionFactory $collectionFactory,
        array $data = []
    ) {
    ...
    protected function _prepareColumns()
    {
        $this->addColumn(
            ...
            [
                ...
                'filter'           => false,
                'is_system'        => true,
                'renderer'         => 'Cytracon\BlueFormBuilderCore\Block\Adminhtml\Form\Submission\Field\Renderer\Action',
		...
		foreach ($elememts as $element) {
            ...
            if (isset($config['type']) && $config['type'] == 'number' && !isset($config['renderer'])) {
                $config['renderer'] = 'Cytracon\BlueFormBuilderCore\Block\Adminhtml\Form\Submission\Field\Renderer\Number';
            }
