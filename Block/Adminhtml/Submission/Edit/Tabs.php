...
namespace Cytracon\BlueFormBuilderCore\Block\Adminhtml\Submission\Edit;
    ...
    protected function _beforeToHtml()
    {
        ...
        if ($submission->getCustomerEmailBody() && $submission->getCustomerRecipients()) {
            $this->addTab(
                ...
                [
                    ...
                    'content' => $this->getLayout()->createBlock('Cytracon\BlueFormBuilderCore\Block\Adminhtml\Submission\Edit\Tab\CustomerNotification')->toHtml()
                ]
            );
        }
        ...
        if ($submission->getEmailBody() && $submission->getRecipients()) {
            $this->addTab(
                ...
                [
                    ...
                    'content' => $this->getLayout()->createBlock('Cytracon\BlueFormBuilderCore\Block\Adminhtml\Submission\Edit\Tab\AdminNotification')->toHtml()
                ]
            );
        }
        ...
        $this->addTab(
            ...
            [
                ...
                'content' => $this->getLayout()->createBlock('Cytracon\BlueFormBuilderCore\Block\Adminhtml\Submission\Edit\Tab\Info')->toHtml()
            ]
        );
        ...
        $this->addTab(
            ...
            [
                'label'   => __('Advanced'),
                'title'   => __('Advanced'),
                'content' => $this->getLayout()->createBlock('Cytracon\BlueFormBuilderCore\Block\Adminhtml\Submission\Edit\Tab\Advanced')->toHtml()
            ]
        );
