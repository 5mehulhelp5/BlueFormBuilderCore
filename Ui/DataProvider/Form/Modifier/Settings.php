    	...
    	$group = $this->addFieldset(
            ...
            $group->addChildren(
                ...
                [
                    ...
                    'additionalInfo' => '<a href="https://blog.cytracon.com/create-multi-language-form-blue-form-builder?utm_campaign=bfb&utm_source=userguide&utm_medium=backend" target="_blank">How to create multi-language forms with Blue Form Builder?</a>'
                ]
            );
