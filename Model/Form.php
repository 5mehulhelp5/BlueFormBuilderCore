...
class Form extends AbstractModel implements FormInterface
{
    ...
    {
        $this->_init(\Cytracon\BlueFormBuilderCore\Model\ResourceModel\Form::class);
    }
        ...
        if ($this->_elements == null) {
            ...
            foreach ($this->_flatElements as $_data) {
                ...
                if ($builderElement && $builderElement->getData('control')) {
                    $_model = '\Cytracon\BlueFormBuilderCore\Model\Element';
                    ...
                    if (!$newElement instanceof \Cytracon\BlueFormBuilderCore\Model\ElementInterface) {
                        throw new \Magento\Framework\Exception\LocalizedException(__($_model . ' doessn\'n not implement \Cytracon\BlueFormBuilderCore\Model\ElementInterface'));
                    }
     ...
     *
     * @return \Cytracon\BlueFormBuilderCore\Model\ResourceModel\Submission\Collection
     */
