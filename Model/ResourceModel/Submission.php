...
class Submission extends AbstractDb
{
     ...
     * Update increment id
     *
     * @param \Cytracon\BlueFormBuilderCore\Model\Submission $object
     * @return $this
     */
    ...
    {
        $incrementPadLength = \Cytracon\BlueFormBuilderCore\Model\Submission::INCREMENT_PAD_LENGTH;
    ...
    {
        /** @var \Cytracon\BlueFormBuilderCore\Model\ResourceModel\File\Collection $collection */
