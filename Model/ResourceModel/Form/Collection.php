...
namespace Cytracon\BlueFormBuilderCore\Model\ResourceModel\Form;

use Cytracon\BlueFormBuilderCore\Api\Data\FormInterface;

class Collection extends \Cytracon\BlueFormBuilderCore\Model\ResourceModel\AbstractCollection
{
    /**
     * @var string
     */
    ...
    {
        $this->_init(\Cytracon\BlueFormBuilderCore\Model\Form::class, \Cytracon\BlueFormBuilderCore\Model\ResourceModel\Form::class);
