...
class Form extends AbstractDb
{
     ...
     * Load an object
     *
     * @param \Cytracon\BlueFormBuilderCore\Model\Form|AbstractModel $object
     * @param mixed $value
    ...
    {
        $connection     = $this->getConnection();
        $entityMetadata = $this->metadataPool->getMetadata(\Cytracon\BlueFormBuilderCore\Api\Data\FormInterface::class);
        $linkField      = $entityMetadata->getLinkField();
