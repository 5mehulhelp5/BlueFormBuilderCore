...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    /**
     * @param  \Cytracon\BlueFormBuilderCore\Model\Submssion $submission 
     * @return string
     */
    ...
    {
        return $this->layout->createBlock('\Cytracon\BlueFormBuilderCore\Block\Form')->setCode($code)->toHtml();
    }
     ...
     * @param $string
     * @param $allowableTags
     * @param $allowHtmlEntities
     * @return mixed|string
     */
    public function removeScript($string, $allowableTags = '<p> <b>', $allowHtmlEntities = false)
    {
        if (is_array($string)) {
     ...
     * @return string
     */
    private function _stripTags($data, $allowableTags = null, $allowHtmlEntities = false)
    {
        $string = preg_replace('#<script(.*?)>(.*?)</script>#is', '', $data);
