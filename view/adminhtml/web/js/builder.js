define([
    'jquery',
    'underscore',
    'Cytracon_Builder/js/ui/form/element/builder'
], function ($, _, BUILDER) {
    'use strict';
    ...
    return BUILDER.extend({
    	...
    	initialize: function () {
            window['bfb'] = {};
            this._super();
            this.source.set('cytraconBuilder.' + this.index + '.builderElements', this.elements);
            ...
            if (this.source) {
                this.source.set('cytraconBuilder.' + this.index + '.elements', elements);
            }
            return this;
        },
