define([
    ...
    return Select.extend({
        defaults: {
            ...
            allFields: false,
            links: {
                elements: '${ $.provider }:cytraconBuilder.profile.elements'
            },
            listens: {
        ...
        getBuilderElements: function() {
            return this.source.get('cytraconBuilder.profile.builderElements');
        },

        getBuilderFields: function() {
            var elements = _.clone(this.source.get('cytraconBuilder.profile.elements'));
