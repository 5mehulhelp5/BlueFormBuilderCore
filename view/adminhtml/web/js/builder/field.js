define([
	'jquery',
	'angular',
	'Cytracon_Core/js/ion.rangeSlider.min'
], function($, angular) {

	var directive = function(cytraconBuilderUrl, elementManager, $compile, $templateRequest) {
		return {
      		replace: true,
			...
			link: function(scope, element) {
				...
				if (builderElement.elementTmpl) {
					$templateRequest(cytraconBuilderUrl.getViewFileUrl(builderElement.elementTmpl)).then(function(html) {
